...
echo "* :ref:\`generic_easyblocks\`" >> $overview
echo >> $overview
...
echo "* :ref:\`vsd_avail_easyconfig_params\`" >> $overview
echo >> $overview
...
echo "* :ref:\`avail_cfgfile_constants\`" >> $overview
echo >> $overview
...
echo "* :ref:\`avail_easyconfig_constants\`" >> $overview
echo >> $overview
...
echo "* :ref:\`avail_easyconfig_licenses\`" >> $overview
echo >> $overview
...
echo "* :ref:\`avail_easyconfig_templates\`" >> $overview
echo >> $overview
...
echo "* :ref:\`vsd_list_easyblocks\`" >> $overview
echo >> $overview
...
echo "* :ref:\`vsd_list_toolchains\`" >> $overview
echo >> $overview
...
echo "* :ref:\`avail_toolchain_opts\`" >> $overview
echo >> $overview
